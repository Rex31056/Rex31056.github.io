    ...
    <div class="cd-table-container">
      <div class="cd-table-wrapper">
            ...
            <div class="cd-table-column-wow">
              <ul>
              <?php
                echo '<li><a href="#" id="username" data-type="text" data-pk="1" data-url="post.php" data-title="Enter username">hello</a></li>';
